...
export type TestOverrides<T> = { [K in keyof T]?: T[K] | undefined };
...
export const createParceiro = (overrides?: TestOverrides<Parceiro>): Parceiro =>
	({
		id: 1,
...
export const createServico = (overrides?: TestOverrides<Servico>): Servico =>
	({
		id: 100,
		f_status: "1",
		f_coghzwfvcnx: 4,
...
export const createCliente = (overrides?: TestOverrides<Cliente>): Cliente =>
	({
		id: 10,
